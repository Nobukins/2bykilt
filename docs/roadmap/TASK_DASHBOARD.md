...
Generated at (UTC): 2025-09-11T13:04:22+00:00
...
| 175 | バッチ行単位成果物キャプチャ基盤 (スクリーンショット/要素値/ログ関連紐付け) | P1 | 2 |  |  |  | 0 | 0 | 0 |  |
| 176 | 宣言的抽出スキーマ (CSV列→コマンド引数/抽出ポリシーマッピング) | P1 | 2 |  |  |  | 0 | 0 | 0 |  |
| 177 | MVP エンタープライズ Readiness マトリクス定義 | P1 | 2 |  |  |  | 0 | 0 | 0 |  |
| 178 | CI: dependency-pipeline workflow 追加 (生成物 idempotent 検証自動化) | P2 | 2 |  |  |  | 0 | 0 | 0 |  |
