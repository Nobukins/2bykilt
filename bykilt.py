...
def main():
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'batch':
        # Delegate all batch command handling to handle_batch_commands()
        handle_batch_commands()
        return 0
...
# Note: The create_batch_parser() and handle_batch_command() functions have been 
# removed to eliminate code duplication. All batch command handling is now 
# consolidated in the handle_batch_commands() function at the top of the file.
